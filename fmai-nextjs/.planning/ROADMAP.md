...
| 6. Vite Feature Parity | 0/?          | Not started | -          |

### Phase 6: Vite Feature Parity — Demos, Interactive Components & Language Switcher

**Goal:** Every skill page in the Next.js site has the same rich interactive demos, pricing sections, trust metrics, and visual components as the original Vite site — plus an enhanced language switcher with flag emojis on all pages
**Depends on:** Phase 1 (website rebrand — complete)
**Requirements**: WEB-01, WEB-03

**Success Criteria** (what must be TRUE):

1. Chatbots skill page has full DemoPlayground with 4 personas (ecommerce, leadgen, support, concierge), MultiPlatformShowcase architecture diagram (Claude AI → Website/Shopify/WhatsApp), ProgressiveCTA, on-page pricing tiers, and trust metrics
2. Voice Agents skill page has VoiceDemoSection with phone mockup UI + ElevenLabs call integration, VoiceDemoFAB floating action button, on-page pricing tiers, and trust metrics
3. Marketing Machine skill page has VisionTimeline (3-era AI adoption), FeatureShowcase with 6 AI modules, SocialProof section, and on-page pricing tiers
4. Automations skill page has on-page pricing tiers (5/10/20 workflows), trust metrics (hours saved, delivery time, success rate), and product demo media
5. Language switcher shows flag emojis + full language names in dropdown with animated transitions on all pages (desktop + mobile)
6. All ported components use next-intl (not react-i18next), follow Next.js App Router patterns, and use existing design tokens
