...
export function VoiceDemoPhone({ call, compact = false }: VoiceDemoPhoneProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center pt-8 pb-4 px-4 flex-shrink-0">
        <div
          className={cn(
            ...
            isActive
              ? 'bg-accent-system/20 shadow-[0_0_30px_rgba(0,212,255,0.3)]'
              : 'bg-accent-system/10'
          )}
        >
          <div
      ...
      {error && (
        <div className="mx-4 mb-2 px-3 py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-xs text-red-400 text-center">
          {error}
        </div>
      )}
          ...
          <>
            <button
              ...
              className={cn(
                ...
                'bg-accent-system hover:bg-accent-system/90 shadow-[0_0_20px_rgba(0,212,255,0.3)]',
