...
export function DemoCompletionCard({
  ...
  return (
    <motion.div
      ...
      className="mx-1 rounded-xl border border-[#00D4FF]/20 bg-gradient-to-br from-[#00D4FF]/10 to-[#A855F7]/5 p-4 backdrop-blur-md"
    >
      <div className="flex items-start gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#00D4FF]/20">
          <PartyPopper className="h-4 w-4 text-[#00D4FF]" />
        </div>
        <div className="flex-1">
          ...
          <p className="mt-2 text-[11px] text-[#00D4FF]/70">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <button
          type="button"
          onClick={onBookCall}
          className="flex cursor-pointer items-center gap-1.5 rounded-full border border-[#00D4FF]/40 bg-[#00D4FF]/20 px-3 py-1.5 text-xs font-medium text-[#00D4FF] transition-colors hover:bg-[#00D4FF]/30"
        >
