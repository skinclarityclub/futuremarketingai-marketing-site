...
interface WizardProgressProps {
  current: number
  total: number
  /** Localised "Stap {current} van {total}" / "Step {current} of {total}". */
  label: string
}

/**
 * Wizard step progress bar — top-sticky on mobile, bottom-sticky on desktop.
 * Mirror van AssessmentProgress.tsx pattern.
 */
