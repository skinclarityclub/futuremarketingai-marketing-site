...
export async function generateMetadata({
  ...
  return generatePageMetadata({ locale, namespace: 'skills-chatbot', path: '/skills/chatbot' })
}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10">
            <TrustMetrics
              metrics={[
                {
                  value: t('trust.metrics.inquiries.value'),
                  label: t('trust.metrics.inquiries.label'),
                  description: t('trust.metrics.inquiries.description'),
                },
                {
