...
export const SKILLS_DATA: readonly SkillData[] = [
  ...
  },
  {
    ...
    name: 'Ad Manager',
    slug: 'ad-manager',
    route: '/skills/ad-manager',
    shortDescription: 'Ads maken én sturen: publiceer naar Meta en volg per advertentie leads, kosten per lead en ad-fatigue.',
    longDescription:
      'Ad Manager maakt complete advertenties (copy, statische visuals en video) en publiceert ze direct naar Meta Ads Manager. Daarna stuurt Clyde op resultaat: per-advertentie prestaties, leads en kosten per lead, ranking- en ad-fatigue-signalen, plus A/B-varianten. Alles in klare taal, ook voor wie geen ads-expert is.',
    features: [
      'AI-gegenereerde ad copy, statische visuals en video-ads',
      'Direct publiceren naar Meta Ads Manager',
      'Per-advertentie prestaties: leads, kosten per lead en ROAS',
      'Ad-fatigue- en ranking-signalen met aanbevelingen in klare taal',
      'A/B-varianten genereren en vergelijken',
      'Concurrentie-onderzoek in de Meta Ad Library',
    ],
    category: 'create',
    status: 'live',
    ...
    serviceType: 'Digital Advertising Management Service',
  },
  {
    id: 'reel-builder',
    name: 'Reel Builder',
