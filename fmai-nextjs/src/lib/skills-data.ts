...
export const SKILLS_DATA: readonly SkillData[] = [
  ...
  },
  {
    ...
    tierCaps: {
      PARTNER: { included: 0, label: 'niet beschikbaar' },
      GROWTH: { included: 4 },
  ...
  },
  {
    ...
    tierCaps: {
      ...
      PROFESSIONAL: { included: 120, label: '120 min/mo' },
      ENTERPRISE: { included: -1, label: 'unlimited' },
      FOUNDING_MEMBER: { included: 60, label: '60 min/mo' },
    },
  },
  {
    id: 'lead-qualifier',
  ...
  },
  {
    ...
    tierCaps: {
      PARTNER: { included: 0, label: 'add-on €47' },
      GROWTH: { included: 200, label: '200 DMs/mo' },
      PROFESSIONAL: { included: 1000, label: '1000 DMs/mo' },
      ENTERPRISE: { included: -1, label: 'unlimited' },
      FOUNDING_MEMBER: { included: 500, label: '500 DMs/mo' },
    },
  },
  {
    id: 'reporting',
