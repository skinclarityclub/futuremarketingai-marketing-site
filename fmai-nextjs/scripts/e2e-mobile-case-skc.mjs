...
const OUT_DIR = '.mobile-test/case-skc'
mkdirSync(OUT_DIR, { recursive: true })

const SECTIONS = [
  { name: '01-chapter1', selector: '#chapter-uitdaging' },
  { name: '02-chapter2', selector: '#chapter-aanpak' },
  { name: '03-chapter3', selector: '#chapter-resultaten' },
  { name: '04-chapter4', selector: '#chapter-operator' },
  { name: '05-chapter5', selector: '#chapter-vervolg' },
]
...
for (const locale of LOCALES) {
  ...
  const url = `http://localhost:3000/${locale}/case-studies/skinclarity-club`
