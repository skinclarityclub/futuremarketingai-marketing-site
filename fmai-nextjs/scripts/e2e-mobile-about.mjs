...
const OUT_DIR = '.mobile-test/about'
mkdirSync(OUT_DIR, { recursive: true })

const SECTIONS = [
  { name: '01-hero', selector: '[aria-labelledby="about-hero"]' },
  { name: '02-mission', selector: '#about-mission' },
  { name: '03-journey', selector: '#about-journey' },
  { name: '04-timeline', selector: '#about-timeline' },
  { name: '05-icp', selector: '#about-icp' },
  { name: '06-infra', selector: '#about-infra' },
  { name: '07-capacity', selector: '#about-capacity' },
  { name: '08-founder', selector: '#about-founder' },
  { name: '09-cta', selector: '#about-cta' },
]
...
for (const locale of LOCALES) {
  ...
  const url = `http://localhost:3000/${locale}/about`
