...
const PAGES = [
  ...
  { name: 'case-studies-skc', path: '/case-studies/skinclarity-club' },
  { name: 'about', path: '/about' },
  { name: 'contact', path: '/contact' },
  { name: 'founding-member', path: '/founding-member' },
  { name: 'how-it-works', path: '/how-it-works' },
  { name: 'skills-social-media', path: '/skills/social-media' },
  { name: 'skills-blog-factory', path: '/skills/blog-factory' },
  { name: 'skills-ad-creator', path: '/skills/ad-creator' },
  { name: 'skills-reel-builder', path: '/skills/reel-builder' },
  { name: 'skills-voice-agent', path: '/skills/voice-agent' },
  { name: 'skills-lead-qualifier', path: '/skills/lead-qualifier' },
  { name: 'skills-email-management', path: '/skills/email-management' },
  { name: 'skills-manychat', path: '/skills/manychat' },
  { name: 'skills-reporting', path: '/skills/reporting' },
  { name: 'skills-seo-geo', path: '/skills/seo-geo' },
  { name: 'skills-research', path: '/skills/research' },
  { name: 'skills-clyde', path: '/skills/clyde' },
  { name: 'blog', path: '/blog' },
