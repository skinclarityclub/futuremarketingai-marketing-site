...
description: "Een AI marketing agent onthoudt het merk per klant en leert over de tijd, en juist dat maakt per-merk-personalisatie en optimalisatie mogelijk. Lees hoe het geheugen werkt en waarom het Clyde's USP is."
author: "Daley Maat"
...
tableOfContents:
  ...
  - id: "hoe-een-agent-onthoudt"
    title: "Hoe een agent onthoudt"
    level: 2
  - id: "hoe-een-agent-leert"
    title: "Hoe een agent leert"
    level: 2
...
<h2 id="hoe-een-agent-onthoudt">Hoe een agent onthoudt</h2>
...
<h2 id="hoe-een-agent-leert">Hoe een agent leert</h2>
