...
export interface TicketData {
  ...
  // Escalation data (card format)
  escalated?: boolean
  agent?: string
  department?: string
  // Escalation data (tool format from escalate_to_human)
  action?: string
  message?: string
...
export function TicketCard({ data }: { data: TicketData }) {
  // Normalize escalation format: tool returns action='escalate', card expects escalated=true
