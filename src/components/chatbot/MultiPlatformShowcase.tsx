...
/**
 * MultiPlatformShowcase — Animated architecture diagram with CSS-only animations.
 *
 * Shows a central "brain" node (Claude AI) connected to 3 platform nodes
 * (Website, Shopify, WhatsApp) with animated connection lines.
 * Includes SKC case study proof section below the diagram.
 */
  ...
  return (
    <ScrollReveal>
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
            ...
            {PLATFORMS.map((platform, index) => {
              ...
              return (
                <ScrollReveal key={platform.id} delay={0.2 * index} direction="right">
                  <div className="bg-white/[0.02] border border-border-primary rounded-card p-4 flex items-start gap-4 min-w-[280px]">
        ...
        <div className="bg-white/[0.02] border border-border-primary rounded-card p-6 lg:p-8 max-w-3xl mx-auto">
