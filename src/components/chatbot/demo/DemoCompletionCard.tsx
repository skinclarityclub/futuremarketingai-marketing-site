    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="font-sans text-sm font-semibold text-text-primary">Demo Complete</p>
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button
          ...
          className="flex cursor-pointer items-center gap-1.5 rounded-full border border-border-primary px-3 py-1.5 text-xs text-text-secondary transition-colors hover:text-text-primary"
        >
        ...
        <button
          type="button"
          onClick={onEndDemo}
          className="cursor-pointer rounded-full border border-border-primary/50 px-3 py-1.5 text-xs text-text-secondary/60 transition-colors hover:text-text-secondary"
        >
          End demo
        </button>
      </div>
