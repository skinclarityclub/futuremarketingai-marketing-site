...
export const Hero: React.FC = () => {
  ...
  // Show industry selector with improved trigger logic
  // 1. First visit: Show after 1s
  // 2. Returning visit without industry: Show after 5s
  React.useEffect(() => {
    ...
    // Returning visit without industry selection: show after 5s
    if (!selectedIndustry) {
      const timer = setTimeout(() => {
        setShowIndustrySelector(true)
      }, 5000)
  ...
  }, [hasSeenIndustrySelector, selectedIndustry])
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9999] flex items-center justify-center">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-900 dark:text-gray-100">{t('hero:loading.scheduling')}</p>
                </div>
              </div>
            </div>
          }
